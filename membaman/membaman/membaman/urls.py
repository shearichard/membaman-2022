...
# The following used to be in urlpatterns but I can no longer have it
# in there withough generating an error. Temporrily I'm moving out here.
#
#re_path(r'^membaman/', include('membaman.urls')),
#re_path(r'^membaman/', include('membaman.urls', namespace="membaman")),
#
#
...
urlpatterns = [ 
    ...
    re_path(r'^fees/', include('fees.urls', namespace="fees")),
...
urlpatterns = [ 
    re_path(r'^$', TemplateView.as_view(template_name='index.html'), name='index'),
    re_path(r'^fees/', include('fees.urls')),
    re_path(r'^members/', include('members.urls')),
    re_path(r'^admin/', admin.site.urls),
]
'''
    #re_path(r'^membaman/', include('membaman.urls', 'membaman')),
urlpatterns = [ 
